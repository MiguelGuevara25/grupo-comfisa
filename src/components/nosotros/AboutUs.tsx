export default function AboutUs() {
  return (
    <section className="mb-20 flex flex-col items-center lg:flex-row">
      <div className="animate__fadeInLeft animate__animated overflow-hidden rounded lg:basis-3/5">
        <img
          src="/photoAboutUs.jpg"
